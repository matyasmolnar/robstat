...
#SBATCH -D /lustre/aoc/projects/hera/mmolnar/robstat/scripts  # Working directory
...
python /lustre/aoc/projects/hera/mmolnar/robstat/scripts/rmdo.py lstb_no_avg/idr2_lstb_14m_ee_1.40949.npz --sigma 4
